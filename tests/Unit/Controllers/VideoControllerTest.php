...
class VideoControllerTest extends TestCase
{
    ...
    public function testUpdate($request, $code, $column, $message, $case = 0, $dummy = true){
        ...
        //サムネイルと動画が通常データの場合
            ...
            $video = Video::where('title', 'test')->first();
        }
    ...
    public function testWatch($register, $rec_many, $case){
        ...
        $category2 = VideoCategory::factory()->create();
        $category3 = VideoCategory::factory()->create();
        $category4 = VideoCategory::factory()->create();
        $category5 = VideoCategory::factory()->create();
        ...
        if($rec_many){
            Video::factory()->hasAttached($category5)->count(10)->create();
        }
